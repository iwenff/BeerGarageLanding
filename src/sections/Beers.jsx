...
export default function Beers() {
  return (
    <section className="section beers" id="beers">
      <div className="blob beers__blob" style={{ background: 'var(--amber-deep)' }} />
      ...
      <div className="container">
        ...
        <img className="beers__deco-2" src="/assets/hydration-radeberger.jpg" alt="" aria-hidden data-reveal />
      </div>
    </section>
  )
}
